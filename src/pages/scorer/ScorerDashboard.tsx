...
export default function ScorerDashboard() {
  ...
  // Track timing of local edits vs remote updates to avoid feedback loops
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        // Ignore echoes of our own recent local edits
  ...
  // Debounced sync to Firestore (single writer pattern)
  useEffect(() => {
    if (!db || !isFirebaseConfigured) return
    const firestore = db
    ...
    // Skip if a remote update arrived in the last 750ms
  ...
  // --- Scoring (race-free: all computation inside the updater) ---
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  This action will clear all scores, player stats, and active game timers.
                </p>
              </div>
            </div>
